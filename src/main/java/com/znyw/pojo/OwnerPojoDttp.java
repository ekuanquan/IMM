...
public class OwnerPojoDttp {
	...
	public String toString() {
		return "OwnerPojoDttp [userAccount=" + userAccount + ", userPwd="
				...
				+ ", cMobile=" + cMobile + ", nomRpt=" + nomRpt
				+ ", engageTest=" + engageTest + ", nomTest=" + nomTest
				+ ", isVideoCheck=" + isVideoCheck + ", areaId=" + areaId
				+ ", areaName=" + areaName + ", isInsurance=" + isInsurance
				+ ", hasBak=" + hasBak + ", isPay=" + isPay + ", usrAlmType="
				+ usrAlmType + ", uMem=" + uMem + ", operName=" + operName
				+ ", define2=" + define2 + ", badMem=" + badMem + ", road="
				+ road + ", define3=" + define3 + ", define1=" + define1
