...
;(function(window,$,undefined){
	...
	function _addRow(row_json){
		...
		$snNum.addClass('table_item_4').text(row_json.snNum).attr("title", snNum);
	...
	function deletSpay(){
		...
		post_async(json, "/IntegratedMM/DeleteDeviceCtrl/deleteSpayBatch.do",_callback_deleteUserZone);
	}
