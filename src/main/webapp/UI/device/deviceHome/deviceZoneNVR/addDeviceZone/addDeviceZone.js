...
;(function(window,$){
    ...
    function _initLayout() {
       ...
       if(popusName == 'addDeviceZoneNVR'){
           ...
           var nowTime = getNowFormatDate().split(" ")[0];
           ...
           probeCount.innerHTML= probeCount.innerHTML + "<option value="+editjson.wantDo+">"+editjson.wantDoName+"</option>";
           ...
           $("#reactivityType_input").append("<option value="+editjson.cameraType+">"+editjson.cameraTypeName+"</option>");
           ...
           cameraMode.innerHTML= cameraMode.innerHTML + "<option value="+editjson.cameraModeId+">"+editjson.cameraModelName+"</option>";
    ...
    function sure(){
       ...
       var end = null;
        ...
        if($("#title_left").text()=="添加监控点"){
            ...
            end = post_sync(json, "../../../../../addNoCamera.do");
            if(end.code = "1000"){
                parent.showiframeDevice.reflaceDeviceZoneNVR();
            }
        }else{
