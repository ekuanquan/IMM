...
;(function(window,$,undefined){
	...
	function _init(){
		...
		$("#title_del").click(function(){
            ...
            if(all_row.length>0){//打钩的批量删除的
                ...
                console.log(JSON.stringify(_global.devMonitorId));
                ...
                $(".selected").each(function(a,b){
                    //_global.devMonitorId.push($(".selected").attr("id"));
                ...
                console.log(JSON.stringify(_global.devMonitorId));
                parent.parent.comfireFloat("确认要删除此监控点" +_global.devMonitorId[0] +"?",deleteZone,cancelCallback);
            }else {
                parent.parent.alertWarn("请先选择所要删除的监控点！",null,null);
            }
	...
	function _addRow(row_json){
		...
		$cameraType.addClass('table_item_5').text(row_json.cameraTypeName).attr(row_json.cameraTypeName);
