...
var rType = {
    face:{
        label:"人脸卡口",
        icon:"../../resource/eMap/images/face.png"
    },
    device:{
        label:"监控设备",
        icon:"../../resource/eMap/images/device.png"
    },
    police:{
        label:"警力资源",
        icon:"../../resource/eMap/images/police.png"
    }
};
var date;
var points = [];
var mapServer = configure("mapServer");
function initialize() {
    require.config({
        baseUrl: "../../resource/eMap/",
        paths: {
    ...
    require(["eMap", "css"], function (EMap) {
        var setting = {
            mapType:"gmap",
            //mapServer:"http://10.26.40.20:2098/",
            mapServer:mapServer,
            ...
            center:{lng:114.47,lat:36.6},
            mapControl:{
                show:false
            },
            imagePath:"../../resource/eMap/",
            cluster:{
                gridSize:30,
...
function mapClick(param){
    ...
    var strHtml = "<div style='width:119px;height:81px;margin-top:13px;margin-left:21px;'>" +
    		        "<div style='height:22px;font-size:12px;color:red;'><div style='margin-top:2px;margin-right:4px;float:left;'><img src='../img/LAL.png'></div>点击选择设备位置</div><div onclick='commitLocation();' style='width:103px;height:25px;line-height:25px;text-align:center;cursor:pointer;margin-top:13px;margin-left:5px;background-color:#2577e5;border:solid 1px;border-radius: 3px;color:#ffffff;'>确定</div>" 
                  "</div>";
...
function addMarker(x,y){
    var marker = {
        ...
        uIcon:{
            ...
            'topOffset': 0,
            'leftOffset': 0,
            'image': '../../resource/eMap/base/skin/images/sign.png',
            'lineWidth': "",
            'opacity': "",
            'color': "",
...
function editMarker(){
    var marker = {
        ...
        uIcon:{
            ...
            'topOffset': 0,
            'leftOffset': 16,
            'image': '../../resource/eMap/base/location.png',//http://10.151.1.83:80/PGIS_S_TileMap/images/tack.gif',
...
function showPathWay() {
    ...
    var uIcon = {//小图标
        ...
        'leftOffset': '',
        'lineArrow': 1,
        'image':'../../resource/eMap/base/skin/images/location.png',
        'lineWidth': document.getElementById('lineWidth').value,
        'opacity': document.getElementById('opacity').value,
        'name': '',
