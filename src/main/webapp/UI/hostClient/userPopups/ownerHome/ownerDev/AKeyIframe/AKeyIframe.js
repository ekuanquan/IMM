...
(function (window, $) {
    ...
    function _addTableRow(row_json, i) {
        var $div_row = $("<tr></tr>");
        var $div_checkbox=$("<td></td>");
        var $dic_checkbox = $("<div></div>");
        var $div_devId = $("<td></td>");
        ...
        $div_checkbox.append($dic_checkbox);
    ...
    function _showAlarmMainframe(areaId, nameOrdevId,platformId) {
        _global.getAKeyframeParams.queryTond.areaId = areaId;
        _global.getAKeyframeParams.queryTond.queryId = nameOrdevId;
        _global.getAKeyframeParams.queryTond.platformId = platformId;
        _getAlarmMainframes();
    }
    ...
    function _getAKeyframesParams() {
        ...
        params.platformId = _global.getAKeyframeParams.queryTond.platformId;
        return params;
    }
