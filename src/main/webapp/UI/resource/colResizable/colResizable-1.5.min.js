...
(function ($) {
    ...
    var init = function (tb, options) {
        ...
        syncCols = function (t, i, isOver) {
            ...
            if (t.opt.followCol!=null&&t.opt.mainCol!=null) {
                var columnsize = t.opt.mainCol.length;
                var followColcolumnsize = t.opt.followCol.length;
                if(followColcolumnsize>0) {
                    for (var i = 0; i < columnsize - 1; i++) {    //遍历Table的所有列
                        t.opt.followCol[i].style.width = t.opt.mainCol[i].style.width;
                    }
                }
            }
            if (t.f) {
    ...
    $.fn.extend({
        colResizable: function (options) {
            var defaults = {
                    draggingClass: 'JCLRgripDrag', //拖动div样式
                    gripInnerHtml: '', //拖动div
                    liveDrag: false, //是否实时拖动
                    fixed: true,
                    minWidth: 0, //最小宽度
                    headerOnly: false, //拖动时只读
                    hoverCursor: "e-resize", //鼠标样式
                    dragCursor: "e-resize", //拖动时鼠标样式
                    postbackSafe: false,
                    flush: false, //
                    marginLeft: null,
                    marginRight: null,
                    ...
                    onResize: null,
                    mainCol:null,//表头列集合
                    followCol:null,//数据表列集合
                    firstColDrag:true//允许首列拉动
                },
