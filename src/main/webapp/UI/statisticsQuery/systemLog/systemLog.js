...
;(function ($, window) {
    ...
    function addTableRow(jsonData, isPre) {
        ...
        $div_operationContent.addClass("usrAlmType_title").text(operationContent).attr("title", operationContent);
    ...
    function _searchEventInfo() {
        ...
        _globalH.getDailyParams=_global.getDailyParams;
