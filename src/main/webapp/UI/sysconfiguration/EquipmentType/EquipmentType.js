...
;(function ( window,$) {
    ...
    function _initEven() {
        ...
        $("#update").bind("click",function () {
            if(_global.flag == 0){
                _global.top.alertTip("请先选择要修改的设备型号！",2000,null);
            }else {
        ...
        $("#close").bind("click",function () {
            if(_global.flag == 0){
                _global.top.alertTip("请先选择要删除的设备型号！",2000,null);
            }
            else{
                if(_global.devModeldata.devModelId=="-1"){
                    _global.top.alertTip("默认设备型号，无法删除！",2000,null);
                }else{
                    _global.top.comfireFloat("是否确认删除设备型号" +_global.devModeldata.devModelId+"?",deletedata,null);
                }
            }
        });
     ...
     ****************************************************/
        function addTableRow(jsonData) {
           ...
           /* $div_CodeWayId_42=$("<td></td>");
            ...
            $div_ChannelNum.addClass("eventNum_title").text(jsonData.ChannelNum).attr("title", jsonData.ChannelNum);
           /* var CodeWayId_42 = "";
