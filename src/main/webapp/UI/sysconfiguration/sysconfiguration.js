...
function iframeManager(iframeName) {
    ...
    switch (iframeName) {
        ...
        case '#storageServiceIframe':
            ...
            break;
        case '#dataUpSetIframe':
            _global.Iframesrc = "./dataUpSet/dataUpSet.html";
             break;
        case '#workstationManagementIframe':
            _global.Iframesrc = "./workstationManagement/workstationManagement.html";
            break;
        default:
            // statements_def
            break;
