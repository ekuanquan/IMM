...
;(function(window,$){
    ...
    window.getLoginUserName = _getLoginUserName;
   ...
   // window.userPopusStaManager = _userPopusStaManager;
	...
	/*function _queryData_page() {
        systemSetting.systemCodeIframe.queryData_page();
    }*/
	//事件绑定函数
	function _initEvent(){
...
*/
	...
	function _open_editRole(){
	     _openPopups($('body'), "../permission/editRole/editRole.html", {
            /*width: 1280,
            height: 720*/
             width: 1000,
             height: 600
	...
	function _open_editEventSetting(){
		 _openMapPopups($('body'), "../userManager/userPopups/eventSetting/editEventSetting/editEventSetting.html", {
            width: 364,
            height: 365
        });	
	}
	function _open_addEventSetting(){
		_openMapPopups($('body'), "../userManager/userPopups/eventSetting/addEventSetting/addEventSetting.html", {
            width: 705,
            height: 580
        });
	}
	function _open_checklinkage_setting(){
		_openMapPopups($('body'), "../userManager/userPopups/eventSetting/checklinkage_setting/checklinkage_setting.html", {
            width: 771,
            height: 532
        });
	}
	function _open_hooklinkage_setting(){
		_openMapPopups($('body'), "../userManager/userPopups/eventSetting/hooklinkage_setting/hooklinkage_setting.html", {
            width: 771,
            height: 532
        });
	}
	function _open_check_addLinkage(){
		_openCusPopups($('body'), "../userManager/userPopups/eventSetting/checklinkage_setting/addLinkage/addLinkage.html", {
            width: 349,
			height: 177
        });
	}
	function _open_check_editLinkage(){
		_openCusPopups($('body'), "../userManager/userPopups/eventSetting/checklinkage_setting/editLinkage/editLinkage.html", {
            width: 349,
			height: 177
        });
	}
	function _open_checkSMS_forwarding(){
		_openMapPopups($('body'), "../userManager/userPopups/eventSetting/checkSMS_forwarding/checkSMS_forwarding.html", {
            width: 771,
            height: 532
        });
	}
	function _open_hookSMS_forwarding(){
		_openMapPopups($('body'), "../userManager/userPopups/eventSetting/hookSMS_forwarding/hookSMS_forwarding.html", {
            width: 771,
            height: 532
        });
	}
    ...
    function _callBack_SystemExit(data) {
        ...
        if (data.result.code == "200") {
            window.top.location = "https://"+ywHeartbeat.heartbeatConfig.serverInfo+"/cas/logout?service=" + _uRL;
        }
        if (data.response) {
