...
//重绘布局
    ...
    var maintainTypeJson = [
  			{"maintainTypeId" : " 0","maintainTypeName" : "维修类型"},
  			{"maintainTypeId" : " 1","maintainTypeName" : "安装"},
 		 	{"maintainTypeId" : " 2","maintainTypeName" : "变更"},
  			{"maintainTypeId" : " 3","maintainTypeName" : "维修探测器"}
	];
    function _initData() {
    ...
    function _searchEventInfo() {
        ...
        maintenancePojo.warrantyTime = maintenancePojo.warrantyTime.replace(" ","T");
    ...
    function addTableRow(jsonData, isPre) {
        ...
        $div_row
            .append($div_maintainNum)
            .append($div_faultCause )
            .append($div_disposalFaultResult )
            .append($div_eventNum )
            ...
            .append($div_applyMaintainer )
            .append($div_warrantyTime )
            .append($div_acceptAlarmer )
            .append($div_warrantyTel )
            .append($div_maintainFormNum )
            .append($div_maintainTime )
            .append($div_maintainUnit )
            .append($div_maintainer )
            /*.append($div_faultAppear )*/
            .append($div_memo )
            .addClass('table_row')
            .attr('id', row_json.maintainNum);

        $div_maintainNum.addClass("maintainNum_title").text(row_json.maintainNum).attr("title", row_json.maintainNum);
        $div_faultCause.addClass("faultCause_title table_title_item").text(row_json.faultCause).attr("title", row_json.faultCause);
        $div_disposalFaultResult.addClass("disposalFaultResult_title table_title_item").text(row_json.disposalFaultResult).attr("title", row_json.disposalFaultResult);
        $div_eventNum.addClass("eventNum_title").text(row_json.eventNum).attr("title", row_json.eventNum);
        $div_usrAlmType .addClass("table_item_time").text(getUsrAlmType(row_json.usrAlmType)).attr("title", getUsrAlmType(row_json.usrAlmType));
        $div_PayNO .addClass("table_item_time").text(row_json.payNO).attr("title", row_json.payNO);
        ...
        $div_applyMaintainer.addClass("applyMaintainer_title table_title_item").text(row_json.applyMaintainer).attr("title", row_json.applyMaintainer);
        $div_warrantyTime.addClass("warrantyTime_title table_title_item_time").text(row_json.warrantyTime).attr("title",row_json.warrantyTime);
        $div_acceptAlarmer.addClass("disposer_title table_title_item").text(row_json.acceptAlarmer).attr("title", row_json.acceptAlarmer);
        $div_warrantyTel.addClass("warrantyTel_title table_title_item").text(row_json.warrantyTel).attr("title", row_json.warrantyTel);
        $div_maintainFormNum.addClass("zoneNum_title").text(row_json.maintainFormNum).attr("title", row_json.maintainFormNum);
        $div_maintainTime.addClass("maintainTime_title table_title_item_time").text(row_json.maintainTime).attr("title", row_json.maintainTime);
        $div_maintainUnit.addClass("maintainUnit_title table_title_item").text(row_json.maintainUnit).attr("title", row_json.maintainUnit);
        $div_maintainer.addClass("maintainer_title table_title_item").text(row_json.maintainer).attr("title", row_json.maintainer);
        /*$div_faultAppear.addClass("faultAppear_title table_title_item").text(row_json.faultAppear).attr("title", row_json.faultAppear);*/
    ...
    function _getAlarmInfos(maintenancePojo) {
        ...
        post_async(params, _config.ajaxUrl.getMaintainListUrl, _callback_getAlarmInfos);
    }
