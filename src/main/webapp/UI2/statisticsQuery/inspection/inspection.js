    ...
    function _queryData_page(page) {
        ...
        var params = {
            queryPojo:{
                queryOperation: "all",
                queryContent: "",
                all: param.queryPojo.all,
                accountNum: param.queryPojo.accountNum,
                accountName: param.queryPojo.accountName,
                cMobile:param.queryPojo.cMobile,
                inspectionFormId: param.queryPojo.inspectionFormId,
                createTime: param.queryPojo.createTime,
            },
            pageInfoPojo: {
                currentPage: param.pageInfoPojo.currentPage,
