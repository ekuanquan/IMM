...
;(function ($, window) {
    ...
    function addTableRow(jsonData, isPre) {
        ...
        $div_centerName.addClass('table_title_item').text(row_json.centerName).attr("title", row_json.centerName);
        $div_acctDY.addClass('table_title_item').text(row_json.acctDY).attr("title", row_json.acctDY);
