...
;(function(window,$,undefined){
	...
	function _initData(){
		_config.UserMonitorData =  parent.parent.getUserMonitorData();
		showData();
	}
	...
	function showOption(row_json){
		...
		$option.attr('value',row_json.cameraId).text(row_json.userMonitorId).appendTo($('#row_select'));
		
	}
	
	function checkOption(){
		var checkOption = _config.UserMonitorData.cameraId;
		$('#row_select').val(checkOption);
	}
