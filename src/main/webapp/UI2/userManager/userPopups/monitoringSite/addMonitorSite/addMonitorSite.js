...
;(function (window, $) {
    ...
    function _initLayout() {
        ...
        if (popusName == 'editMonitorSite') {
            ...
            $("#userMonitorId_input").val(editjson.userMonitorId).attr("title",editjson.userMonitorId);
            ...
            $("#wantDo_input").val(editjson.wantDo).attr("title",editjson.wantDo);
            $("#cameraType_input").val(editjson.cameraType).attr("title",editjson.cameraType);
            $("#cameraModel_input").val(editjson.cameraModel).attr("title",editjson.cameraModel);
    ...
    function _getRoleZoneParams() {
        ...
        params.roleId = rowJson.roleId;
        params.userMonitorId = $("#userMonitorId_input").val();
